...
- **AI Code**: Gemini 3.1 Pro via Interactions API (@google/genai SDK, GEMINI_API_KEY env var, stateful conversations with previous_interaction_id, thinkingConfig support)
