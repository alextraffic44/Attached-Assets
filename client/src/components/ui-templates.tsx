...
const CARD_TEMPLATES: UITemplate[] = [
  {
    ...
    html: `<div class="profile-card-uv">\n  <div class="profile-img-uv">A</div>\n  <h3 class="profile-name-uv">John Doe</h3>\n  <p class="profile-role-uv">UI Designer</p>\n  <div class="profile-stats-uv">\n    <div><strong>120</strong><span>Posts</span></div>\n    <div><strong>8.5K</strong><span>Followers</span></div>\n    <div><strong>350</strong><span>Following</span></div>\n  </div>\n</div>`,
    css: `.profile-card-uv { background: #1e1e1e; border-radius: 16px; padding: 30px; text-align: center; color: #fff; font-family: system-ui, sans-serif; width: 260px; }\n.profile-img-uv { width: 80px; height: 80px; border-radius: 50%; background: linear-gradient(135deg, #667eea, #764ba2); margin: 0 auto 16px; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: 700; }\n.profile-name-uv { font-size: 1.2rem; font-weight: 600; margin-bottom: 4px; }\n.profile-role-uv { color: #888; font-size: 0.85rem; margin-bottom: 20px; }\n.profile-stats-uv { display: flex; justify-content: space-around; border-top: 1px solid #333; padding-top: 16px; }\n.profile-stats-uv div { text-align: center; }\n.profile-stats-uv strong { display: block; font-size: 1rem; }\n.profile-stats-uv span { font-size: 0.7rem; color: #888; }`,
  },
  {
    id: "card-pricing",
    name: "Pricing Card",
    author: "vinodjangid07",
    html: `<div class="pricing-card-uv">\n  <div class="pricing-badge-uv">Popular</div>\n  <h3 class="pricing-plan-uv">Pro Plan</h3>\n  <div class="pricing-price-uv">$29<span>/mo</span></div>\n  <ul class="pricing-list-uv">\n    <li>✓ Unlimited projects</li>\n    <li>✓ Priority support</li>\n    <li>✓ Custom domains</li>\n    <li>✓ Analytics</li>\n  </ul>\n  <button class="pricing-btn-uv">Get Started</button>\n</div>`,
    css: `.pricing-card-uv { background: #1a1a2e; border: 1px solid #333; border-radius: 16px; padding: 30px; color: #fff; font-family: system-ui, sans-serif; width: 260px; position: relative; overflow: hidden; }\n.pricing-badge-uv { position: absolute; top: 16px; right: -30px; background: linear-gradient(135deg, #667eea, #764ba2); padding: 4px 40px; font-size: 0.7rem; font-weight: 700; transform: rotate(45deg); text-transform: uppercase; }\n.pricing-plan-uv { font-size: 1.1rem; color: #888; margin-bottom: 8px; }\n.pricing-price-uv { font-size: 2.5rem; font-weight: 700; margin-bottom: 20px; }\n.pricing-price-uv span { font-size: 0.9rem; color: #888; font-weight: 400; }\n.pricing-list-uv { list-style: none; padding: 0; margin-bottom: 24px; }\n.pricing-list-uv li { padding: 8px 0; border-bottom: 1px solid #222; font-size: 0.85rem; color: #ccc; }\n.pricing-btn-uv { width: 100%; padding: 12px; border: none; border-radius: 10px; background: linear-gradient(135deg, #667eea, #764ba2); color: #fff; font-size: 0.9rem; font-weight: 600; cursor: pointer; transition: transform 0.2s; }\n.pricing-btn-uv:hover { transform: translateY(-2px); }`,
  },
  {
    id: "card-product",
    name: "Product Card",
    author: "Smit-Prajapati",
    html: `<div class="product-card-uv">\n  <div class="product-img-uv">📦</div>\n  <div class="product-info-uv">\n    <span class="product-cat-uv">Electronics</span>\n    <h3>Wireless Speaker</h3>\n    <p class="product-desc-uv">Premium sound quality with 24h battery life</p>\n    <div class="product-bottom-uv">\n      <span class="product-price-uv">$89.99</span>\n      <button class="product-buy-uv">Add to Cart</button>\n    </div>\n  </div>\n</div>`,
    css: `.product-card-uv { background: #1e1e1e; border-radius: 16px; overflow: hidden; width: 260px; color: #fff; font-family: system-ui, sans-serif; transition: transform 0.3s; }\n.product-card-uv:hover { transform: translateY(-5px); }\n.product-img-uv { height: 160px; background: linear-gradient(135deg, #1a1a2e, #16213e); display: flex; align-items: center; justify-content: center; font-size: 3rem; }\n.product-info-uv { padding: 20px; }\n.product-cat-uv { font-size: 0.7rem; text-transform: uppercase; color: #667eea; letter-spacing: 1px; }\n.product-info-uv h3 { margin: 8px 0; font-size: 1.1rem; }\n.product-desc-uv { font-size: 0.8rem; color: #888; margin-bottom: 16px; }\n.product-bottom-uv { display: flex; align-items: center; justify-content: space-between; }\n.product-price-uv { font-size: 1.2rem; font-weight: 700; }\n.product-buy-uv { padding: 8px 16px; border: none; border-radius: 8px; background: #667eea; color: #fff; font-size: 0.8rem; cursor: pointer; transition: background 0.2s; }\n.product-buy-uv:hover { background: #5a6fd6; }`,
  },
  {
    id: "card-notification",
    name: "Notification",
    author: "zanina-yassine",
    html: `<div class="notif-card-uv">\n  <div class="notif-icon-uv">🔔</div>\n  <div class="notif-content-uv">\n    <h4>New Message</h4>\n    <p>You have 3 unread messages from your team.</p>\n    <span class="notif-time-uv">2 minutes ago</span>\n  </div>\n  <button class="notif-close-uv">×</button>\n</div>`,
    css: `.notif-card-uv { display: flex; gap: 14px; background: #1e1e1e; border: 1px solid #333; border-left: 4px solid #3b82f6; border-radius: 12px; padding: 16px; color: #fff; font-family: system-ui, sans-serif; width: 320px; align-items: flex-start; }\n.notif-icon-uv { font-size: 1.5rem; flex-shrink: 0; }\n.notif-content-uv h4 { font-size: 0.9rem; margin-bottom: 4px; }\n.notif-content-uv p { font-size: 0.8rem; color: #999; margin-bottom: 6px; }\n.notif-time-uv { font-size: 0.7rem; color: #666; }\n.notif-close-uv { background: none; border: none; color: #666; font-size: 1.2rem; cursor: pointer; margin-left: auto; padding: 0; line-height: 1; }\n.notif-close-uv:hover { color: #fff; }`,
  },
  {
    id: "card-testimonial",
    name: "Testimonial",
    author: "cssbuttons-io",
    html: `<div class="testi-card-uv">\n  <div class="testi-quote-uv">"</div>\n  <p class="testi-text-uv">This product completely transformed our workflow. The team loves it and our productivity increased by 40%.</p>\n  <div class="testi-author-uv">\n    <div class="testi-avatar-uv">S</div>\n    <div>\n      <strong>Sarah Chen</strong>\n      <span>CEO at TechFlow</span>\n    </div>\n  </div>\n</div>`,
    css: `.testi-card-uv { background: #1a1a2e; border-radius: 16px; padding: 28px; color: #fff; font-family: system-ui, sans-serif; width: 280px; }\n.testi-quote-uv { font-size: 3rem; color: #667eea; line-height: 1; margin-bottom: -10px; font-family: Georgia, serif; }\n.testi-text-uv { font-size: 0.85rem; color: #ccc; line-height: 1.6; margin-bottom: 20px; }\n.testi-author-uv { display: flex; align-items: center; gap: 12px; }\n.testi-avatar-uv { width: 40px; height: 40px; border-radius: 50%; background: linear-gradient(135deg, #667eea, #764ba2); display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1rem; }\n.testi-author-uv strong { display: block; font-size: 0.85rem; }\n.testi-author-uv span { font-size: 0.7rem; color: #888; }`,
  },
  {
    id: "card-stat",
    name: "Stats Card",
    author: "gharsh11032000",
    html: `<div class="stat-card-uv">\n  <div class="stat-icon-uv">📈</div>\n  <div class="stat-value-uv">$12,875</div>\n  <div class="stat-label-uv">Total Revenue</div>\n  <div class="stat-change-uv">↑ 12.5% from last month</div>\n</div>`,
    css: `.stat-card-uv { background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 16px; padding: 24px; color: #fff; font-family: system-ui, sans-serif; width: 220px; }\n.stat-icon-uv { font-size: 1.5rem; margin-bottom: 12px; }\n.stat-value-uv { font-size: 1.8rem; font-weight: 700; margin-bottom: 4px; }\n.stat-label-uv { font-size: 0.8rem; color: #888; margin-bottom: 12px; }\n.stat-change-uv { font-size: 0.75rem; color: #4ade80; background: #4ade8015; padding: 4px 10px; border-radius: 20px; display: inline-block; }`,
  },
  {
    id: "card-social",
    name: "Social Card",
    author: "itsKrish01",
    html: `<div class="social-card-uv">\n  <div class="social-header-uv">\n    <div class="social-avatar-uv">J</div>\n    <div>\n      <strong>@johndoe</strong>\n      <span>2h ago</span>\n    </div>\n  </div>\n  <p class="social-body-uv">Just shipped a new feature! 🚀 Check it out and let me know what you think.</p>\n  <div class="social-actions-uv">\n    <span>❤️ 245</span>\n    <span>💬 18</span>\n    <span>🔄 42</span>\n  </div>\n</div>`,
    css: `.social-card-uv { background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 16px; padding: 20px; color: #fff; font-family: system-ui, sans-serif; width: 300px; }\n.social-header-uv { display: flex; align-items: center; gap: 12px; margin-bottom: 14px; }\n.social-avatar-uv { width: 40px; height: 40px; border-radius: 50%; background: #3b82f6; display: flex; align-items: center; justify-content: center; font-weight: 700; }\n.social-header-uv strong { display: block; font-size: 0.9rem; }\n.social-header-uv span { font-size: 0.7rem; color: #888; }\n.social-body-uv { font-size: 0.85rem; color: #ccc; line-height: 1.5; margin-bottom: 16px; }\n.social-actions-uv { display: flex; gap: 20px; font-size: 0.8rem; color: #888; }\n.social-actions-uv span { cursor: pointer; transition: color 0.2s; }\n.social-actions-uv span:hover { color: #fff; }`,
  },
  {
    id: "card-glass",
    name: "Glass Card",
    author: "adamgiebl",
    html: `<div class="glass-card-uv">\n  <div class="glass-shine-uv"></div>\n  <h3>Glass Effect</h3>\n  <p>A beautiful frosted glass card with subtle reflections and depth.</p>\n</div>`,
    css: `.glass-card-uv { position: relative; background: rgba(255,255,255,0.05); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1); border-radius: 16px; padding: 28px; color: #fff; font-family: system-ui, sans-serif; width: 260px; overflow: hidden; }\n.glass-shine-uv { position: absolute; top: -50%; left: -50%; width: 200%; height: 200%; background: linear-gradient(transparent, rgba(255,255,255,0.03), transparent); transform: rotate(30deg); pointer-events: none; }\n.glass-card-uv h3 { font-size: 1.1rem; margin-bottom: 8px; position: relative; }\n.glass-card-uv p { font-size: 0.8rem; color: #aaa; line-height: 1.5; position: relative; }`,
  },
  {
    id: "card-weather",
    name: "Weather Card",
    author: "mrhyddenn",
    html: `<div class="weather-card-uv">\n  <div class="weather-top-uv">\n    <span class="weather-icon-uv">☀️</span>\n    <div class="weather-temp-uv">24°</div>\n  </div>\n  <div class="weather-city-uv">San Francisco</div>\n  <div class="weather-details-uv">\n    <div><span>💧</span> 45%</div>\n    <div><span>💨</span> 12 km/h</div>\n    <div><span>👁</span> 10 km</div>\n  </div>\n</div>`,
    css: `.weather-card-uv { background: linear-gradient(135deg, #1a1a2e, #16213e); border-radius: 20px; padding: 24px; color: #fff; font-family: system-ui, sans-serif; width: 240px; }\n.weather-top-uv { display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px; }\n.weather-icon-uv { font-size: 2.5rem; }\n.weather-temp-uv { font-size: 3rem; font-weight: 200; }\n.weather-city-uv { font-size: 1rem; color: #aaa; margin-bottom: 20px; }\n.weather-details-uv { display: flex; justify-content: space-between; font-size: 0.8rem; color: #888; border-top: 1px solid #ffffff15; padding-top: 14px; }\n.weather-details-uv span { margin-right: 4px; }`,
  },
  {
    id: "card-music",
    name: "Music Player",
    author: "Yaya12085",
    html: `<div class="music-card-uv">\n  <div class="music-cover-uv">🎵</div>\n  <div class="music-info-uv">\n    <h4>Blinding Lights</h4>\n    <span>The Weeknd</span>\n  </div>\n  <div class="music-progress-uv"><div class="music-bar-uv"></div></div>\n  <div class="music-controls-uv">\n    <span>⏮</span><span class="music-play-uv">▶</span><span>⏭</span>\n  </div>\n</div>`,
    css: `.music-card-uv { background: #1a1a1a; border-radius: 16px; padding: 20px; color: #fff; font-family: system-ui, sans-serif; width: 260px; text-align: center; }\n.music-cover-uv { width: 100%; height: 140px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 3rem; margin-bottom: 16px; }\n.music-info-uv h4 { font-size: 1rem; margin-bottom: 2px; }\n.music-info-uv span { font-size: 0.8rem; color: #888; }\n.music-progress-uv { height: 4px; background: #333; border-radius: 2px; margin: 16px 0; overflow: hidden; }\n.music-bar-uv { width: 45%; height: 100%; background: #667eea; border-radius: 2px; }\n.music-controls-uv { display: flex; justify-content: center; gap: 28px; font-size: 1.2rem; }\n.music-controls-uv span { cursor: pointer; opacity: 0.6; transition: opacity 0.2s; }\n.music-controls-uv span:hover { opacity: 1; }\n.music-play-uv { opacity: 1 !important; }`,
  },
  {
    id: "card-team",
    name: "Team Member",
    author: "alexmaracinaru",
    html: `<div class="team-card-uv">\n  <div class="team-photo-uv">👤</div>\n  <h3>Alex Smith</h3>\n  <p class="team-role-uv">Lead Developer</p>\n  <div class="team-socials-uv">\n    <span>🐙</span><span>🐦</span><span>💼</span>\n  </div>\n</div>`,
    css: `.team-card-uv { background: #1e1e1e; border-radius: 16px; padding: 28px; text-align: center; color: #fff; font-family: system-ui, sans-serif; width: 220px; transition: transform 0.3s; }\n.team-card-uv:hover { transform: translateY(-5px); }\n.team-photo-uv { width: 80px; height: 80px; border-radius: 50%; background: linear-gradient(135deg, #f093fb, #f5576c); margin: 0 auto 16px; display: flex; align-items: center; justify-content: center; font-size: 2rem; }\n.team-card-uv h3 { font-size: 1rem; margin-bottom: 4px; }\n.team-role-uv { font-size: 0.8rem; color: #888; margin-bottom: 16px; }\n.team-socials-uv { display: flex; justify-content: center; gap: 16px; font-size: 1.2rem; }\n.team-socials-uv span { cursor: pointer; opacity: 0.5; transition: opacity 0.2s; }\n.team-socials-uv span:hover { opacity: 1; }`,
  },
  {
    id: "card-feature",
    name: "Feature Card",
    author: "Nawsome",
    html: `<div class="feat-card-uv">\n  <div class="feat-icon-uv">⚡</div>\n  <h3>Lightning Fast</h3>\n  <p>Optimized performance with sub-second load times across all devices.</p>\n</div>`,
    css: `.feat-card-uv { background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 16px; padding: 28px; color: #fff; font-family: system-ui, sans-serif; width: 240px; transition: border-color 0.3s, transform 0.3s; }\n.feat-card-uv:hover { border-color: #667eea; transform: translateY(-3px); }\n.feat-icon-uv { width: 48px; height: 48px; background: #667eea20; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; margin-bottom: 16px; }\n.feat-card-uv h3 { font-size: 1rem; margin-bottom: 8px; }\n.feat-card-uv p { font-size: 0.8rem; color: #888; line-height: 1.5; }`,
  },
  {
    id: "card-blog",
    name: "Blog Post",
    author: "Pradeepsaranbishnoi",
    html: `<div class="blog-card-uv">\n  <div class="blog-img-uv">📝</div>\n  <div class="blog-body-uv">\n    <span class="blog-tag-uv">Design</span>\n    <h3>Creating Beautiful UIs</h3>\n    <p>Learn the fundamentals of modern interface design and best practices...</p>\n    <div class="blog-meta-uv">\n      <span>Jan 15, 2025</span>\n      <span>5 min read</span>\n    </div>\n  </div>\n</div>`,
    css: `.blog-card-uv { background: #1e1e1e; border-radius: 16px; overflow: hidden; width: 280px; color: #fff; font-family: system-ui, sans-serif; transition: transform 0.3s; }\n.blog-card-uv:hover { transform: translateY(-5px); }\n.blog-img-uv { height: 140px; background: linear-gradient(135deg, #0f0c29, #302b63, #24243e); display: flex; align-items: center; justify-content: center; font-size: 2.5rem; }\n.blog-body-uv { padding: 20px; }\n.blog-tag-uv { font-size: 0.7rem; background: #667eea30; color: #667eea; padding: 3px 10px; border-radius: 20px; }\n.blog-body-uv h3 { font-size: 1rem; margin: 10px 0 6px; }\n.blog-body-uv p { font-size: 0.8rem; color: #888; line-height: 1.4; margin-bottom: 14px; }\n.blog-meta-uv { display: flex; justify-content: space-between; font-size: 0.7rem; color: #666; }`,
  },
  {
    id: "card-todo",
    name: "Todo Item",
    author: "martinval11",
    html: `<div class="todo-card-uv">\n  <input type="checkbox" class="todo-check-uv" checked>\n  <div class="todo-text-uv">\n    <span class="todo-title-uv">Complete the project</span>\n    <span class="todo-due-uv">Due: Tomorrow</span>\n  </div>\n  <span class="todo-priority-uv">!</span>\n</div>`,
    css: `.todo-card-uv { display: flex; align-items: center; gap: 14px; background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 12px; padding: 16px; color: #fff; font-family: system-ui, sans-serif; width: 300px; }\n.todo-check-uv { width: 20px; height: 20px; accent-color: #667eea; cursor: pointer; flex-shrink: 0; }\n.todo-title-uv { display: block; font-size: 0.9rem; }\n.todo-due-uv { font-size: 0.7rem; color: #888; }\n.todo-priority-uv { margin-left: auto; background: #ef444430; color: #ef4444; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.8rem; font-weight: 700; }`,
  },
  {
    id: "card-user-mini",
    name: "User Mini Card",
    author: "barisdogansutcu",
    html: `<div class="usermini-card-uv">\n  <div class="usermini-avatar-uv">M</div>\n  <div class="usermini-info-uv">\n    <strong>Maria Garcia</strong>\n    <span>Online</span>\n  </div>\n  <button class="usermini-btn-uv">Follow</button>\n</div>`,
    css: `.usermini-card-uv { display: flex; align-items: center; gap: 12px; background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 12px; padding: 14px 18px; color: #fff; font-family: system-ui, sans-serif; width: 280px; }\n.usermini-avatar-uv { width: 40px; height: 40px; border-radius: 50%; background: linear-gradient(135deg, #10b981, #059669); display: flex; align-items: center; justify-content: center; font-weight: 700; flex-shrink: 0; }\n.usermini-info-uv strong { display: block; font-size: 0.85rem; }\n.usermini-info-uv span { font-size: 0.7rem; color: #10b981; }\n.usermini-btn-uv { margin-left: auto; padding: 6px 16px; background: transparent; border: 1px solid #667eea; color: #667eea; border-radius: 20px; font-size: 0.75rem; cursor: pointer; transition: all 0.2s; }\n.usermini-btn-uv:hover { background: #667eea; color: #fff; }`,
  },
  {
    id: "card-gradient-border",
    name: "Gradient Border",
    author: "Spacious74",
    html: `<div class="gborder-card-uv">\n  <div class="gborder-inner-uv">\n    <h3>Premium</h3>\n    <p>Experience the best with our premium features and exclusive content.</p>\n  </div>\n</div>`,
    css: `.gborder-card-uv { padding: 2px; background: linear-gradient(135deg, #667eea, #764ba2, #f093fb); border-radius: 16px; width: 260px; }\n.gborder-inner-uv { background: #1a1a1a; border-radius: 14px; padding: 28px; color: #fff; font-family: system-ui, sans-serif; }\n.gborder-inner-uv h3 { font-size: 1.1rem; margin-bottom: 8px; }\n.gborder-inner-uv p { font-size: 0.8rem; color: #888; line-height: 1.5; }`,
  },
  {
    id: "card-download",
    name: "Download Card",
    author: "portseif",
    html: `<div class="dl-card-uv">\n  <div class="dl-file-uv">📄</div>\n  <div class="dl-info-uv">\n    <h4>Project_Brief.pdf</h4>\n    <span>2.4 MB • PDF Document</span>\n  </div>\n  <button class="dl-action-uv">⬇</button>\n</div>`,
    css: `.dl-card-uv { display: flex; align-items: center; gap: 14px; background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 12px; padding: 16px; color: #fff; font-family: system-ui, sans-serif; width: 300px; }\n.dl-file-uv { font-size: 2rem; flex-shrink: 0; }\n.dl-info-uv h4 { font-size: 0.85rem; margin-bottom: 2px; }\n.dl-info-uv span { font-size: 0.7rem; color: #888; }\n.dl-action-uv { margin-left: auto; width: 36px; height: 36px; border-radius: 50%; background: #667eea20; border: none; color: #667eea; font-size: 1rem; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: background 0.2s; }\n.dl-action-uv:hover { background: #667eea40; }`,
  },
  {
    id: "card-countdown",
    name: "Countdown",
    author: "TaniaDou",
    html: `<div class="countdown-card-uv">\n  <h3>Launch Day</h3>\n  <div class="countdown-boxes-uv">\n    <div class="cd-box-uv"><span>12</span><small>Days</small></div>\n    <div class="cd-box-uv"><span>08</span><small>Hours</small></div>\n    <div class="cd-box-uv"><span>42</span><small>Mins</small></div>\n    <div class="cd-box-uv"><span>15</span><small>Secs</small></div>\n  </div>\n</div>`,
    css: `.countdown-card-uv { background: #1a1a2e; border-radius: 16px; padding: 28px; text-align: center; color: #fff; font-family: system-ui, sans-serif; width: 280px; }\n.countdown-card-uv h3 { font-size: 1rem; color: #888; margin-bottom: 20px; text-transform: uppercase; letter-spacing: 2px; }\n.countdown-boxes-uv { display: flex; justify-content: center; gap: 10px; }\n.cd-box-uv { background: #16213e; border-radius: 10px; padding: 14px 12px; min-width: 56px; }\n.cd-box-uv span { display: block; font-size: 1.6rem; font-weight: 700; }\n.cd-box-uv small { font-size: 0.6rem; color: #888; text-transform: uppercase; }`,
  },
  {
    id: "card-cookie",
    name: "Cookie Banner",
    author: "Ali-Tahmazi99",
    html: `<div class="cookie-card-uv">\n  <div class="cookie-icon-uv">🍪</div>\n  <p>We use cookies to enhance your browsing experience. By continuing, you agree to our use of cookies.</p>\n  <div class="cookie-btns-uv">\n    <button class="cookie-accept-uv">Accept</button>\n    <button class="cookie-decline-uv">Decline</button>\n  </div>\n</div>`,
    css: `.cookie-card-uv { background: #1e1e1e; border: 1px solid #333; border-radius: 16px; padding: 20px; color: #fff; font-family: system-ui, sans-serif; width: 300px; }\n.cookie-icon-uv { font-size: 1.5rem; margin-bottom: 10px; }\n.cookie-card-uv p { font-size: 0.8rem; color: #aaa; line-height: 1.5; margin-bottom: 16px; }\n.cookie-btns-uv { display: flex; gap: 10px; }\n.cookie-accept-uv { flex: 1; padding: 10px; border: none; border-radius: 8px; background: #667eea; color: #fff; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: background 0.2s; }\n.cookie-accept-uv:hover { background: #5a6fd6; }\n.cookie-decline-uv { flex: 1; padding: 10px; border: 1px solid #444; border-radius: 8px; background: transparent; color: #aaa; font-size: 0.85rem; cursor: pointer; transition: all 0.2s; }\n.cookie-decline-uv:hover { border-color: #888; color: #fff; }`,
  },
  {
    id: "card-achievement",
    name: "Achievement",
    author: "SpatexDEV",
    html: `<div class="achieve-card-uv">\n  <div class="achieve-medal-uv">🏆</div>\n  <h3>First Milestone!</h3>\n  <p>You completed your first 100 tasks. Keep going!</p>\n  <div class="achieve-progress-uv"><div class="achieve-bar-uv"></div></div>\n  <span class="achieve-pct-uv">75% to next level</span>\n</div>`,
    css: `.achieve-card-uv { background: linear-gradient(135deg, #1a1a2e, #0f0f1e); border: 1px solid #fbbf2433; border-radius: 16px; padding: 24px; text-align: center; color: #fff; font-family: system-ui, sans-serif; width: 240px; }\n.achieve-medal-uv { font-size: 2.5rem; margin-bottom: 12px; }\n.achieve-card-uv h3 { font-size: 1rem; margin-bottom: 6px; }\n.achieve-card-uv p { font-size: 0.75rem; color: #888; margin-bottom: 16px; }\n.achieve-progress-uv { height: 6px; background: #333; border-radius: 3px; overflow: hidden; margin-bottom: 8px; }\n.achieve-bar-uv { width: 75%; height: 100%; background: linear-gradient(90deg, #fbbf24, #f59e0b); border-radius: 3px; }\n.achieve-pct-uv { font-size: 0.7rem; color: #fbbf24; }`,
  },
  {
    id: "card-login-mini",
    name: "Login Card",
    author: "cssbuttons-io",
    html: `<div class="loginc-card-uv">\n  <h3>Welcome back</h3>\n  <p>Sign in to your account</p>\n  <input class="loginc-input-uv" placeholder="Email">\n  <input class="loginc-input-uv" type="password" placeholder="Password">\n  <button class="loginc-btn-uv">Sign In</button>\n  <span class="loginc-link-uv">Forgot password?</span>\n</div>`,
    css: `.loginc-card-uv { background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 16px; padding: 28px; color: #fff; font-family: system-ui, sans-serif; width: 280px; }\n.loginc-card-uv h3 { font-size: 1.1rem; margin-bottom: 4px; }\n.loginc-card-uv p { font-size: 0.8rem; color: #888; margin-bottom: 20px; }\n.loginc-input-uv { width: 100%; padding: 12px; background: #111; border: 1px solid #333; border-radius: 8px; color: #fff; font-size: 0.85rem; margin-bottom: 12px; outline: none; box-sizing: border-box; }\n.loginc-input-uv:focus { border-color: #667eea; }\n.loginc-btn-uv { width: 100%; padding: 12px; border: none; border-radius: 8px; background: #667eea; color: #fff; font-size: 0.9rem; font-weight: 600; cursor: pointer; margin-bottom: 12px; transition: background 0.2s; }\n.loginc-btn-uv:hover { background: #5a6fd6; }\n.loginc-link-uv { font-size: 0.75rem; color: #667eea; cursor: pointer; display: block; text-align: center; }`,
  },
  {
    id: "card-neon-border",
    name: "Neon Card",
    author: "adamgiebl",
    html: `<div class="neonc-card-uv">\n  <h3>Neon Effect</h3>\n  <p>Cards with glowing neon borders and subtle shadow effects.</p>\n</div>`,
    css: `.neonc-card-uv { background: #0a0a0a; border: 1px solid #0ff3; border-radius: 16px; padding: 28px; color: #fff; font-family: system-ui, sans-serif; width: 260px; box-shadow: 0 0 15px #0ff2, inset 0 0 15px #0ff1; transition: box-shadow 0.3s; }\n.neonc-card-uv:hover { box-shadow: 0 0 30px #0ff3, inset 0 0 20px #0ff2; }\n.neonc-card-uv h3 { font-size: 1.1rem; color: #0ff; margin-bottom: 8px; }\n.neonc-card-uv p { font-size: 0.8rem; color: #888; line-height: 1.5; }`,
  },
  {
    id: "card-rating",
    name: "Rating Card",
    author: "vinodjangid07",
    html: `<div class="rating-card-uv">\n  <div class="rating-stars-uv">★★★★☆</div>\n  <div class="rating-score-uv">4.0</div>\n  <p>Based on 2,847 reviews</p>\n  <div class="rating-bars-uv">\n    <div class="rb-row-uv"><span>5</span><div class="rb-track-uv"><div class="rb-fill-uv" style="width:65%"></div></div></div>\n    <div class="rb-row-uv"><span>4</span><div class="rb-track-uv"><div class="rb-fill-uv" style="width:25%"></div></div></div>\n    <div class="rb-row-uv"><span>3</span><div class="rb-track-uv"><div class="rb-fill-uv" style="width:7%"></div></div></div>\n  </div>\n</div>`,
    css: `.rating-card-uv { background: #1e1e1e; border-radius: 16px; padding: 24px; text-align: center; color: #fff; font-family: system-ui, sans-serif; width: 240px; }\n.rating-stars-uv { color: #fbbf24; font-size: 1.3rem; letter-spacing: 4px; }\n.rating-score-uv { font-size: 2.5rem; font-weight: 700; margin: 4px 0; }\n.rating-card-uv p { font-size: 0.75rem; color: #888; margin-bottom: 16px; }\n.rating-bars-uv { text-align: left; }\n.rb-row-uv { display: flex; align-items: center; gap: 8px; margin-bottom: 6px; font-size: 0.75rem; color: #888; }\n.rb-track-uv { flex: 1; height: 6px; background: #333; border-radius: 3px; overflow: hidden; }\n.rb-fill-uv { height: 100%; background: #fbbf24; border-radius: 3px; }`,
  },
  {
    id: "card-file-upload",
    name: "Upload Card",
    author: "JkHuger",
    html: `<div class="upload-card-uv">\n  <div class="upload-area-uv">\n    <span class="upload-icon-uv">☁️</span>\n    <p>Drag & drop files here</p>\n    <span class="upload-hint-uv">or click to browse</span>\n  </div>\n  <div class="upload-file-uv">\n    <span>📄 design_v2.fig</span>\n    <span class="upload-size-uv">4.2 MB</span>\n  </div>\n</div>`,
    css: `.upload-card-uv { background: #1e1e1e; border-radius: 16px; padding: 20px; color: #fff; font-family: system-ui, sans-serif; width: 280px; }\n.upload-area-uv { border: 2px dashed #444; border-radius: 12px; padding: 30px; text-align: center; margin-bottom: 14px; transition: border-color 0.3s; cursor: pointer; }\n.upload-area-uv:hover { border-color: #667eea; }\n.upload-icon-uv { font-size: 2rem; display: block; margin-bottom: 8px; }\n.upload-area-uv p { font-size: 0.85rem; margin-bottom: 4px; }\n.upload-hint-uv { font-size: 0.7rem; color: #667eea; }\n.upload-file-uv { display: flex; justify-content: space-between; padding: 12px; background: #161616; border-radius: 8px; font-size: 0.8rem; }\n.upload-size-uv { color: #888; }`,
  },
  {
    id: "card-timeline",
    name: "Timeline Card",
    author: "elijahgummer",
    html: `<div class="timeline-card-uv">\n  <div class="tl-item-uv">\n    <div class="tl-dot-uv"></div>\n    <div class="tl-content-uv"><strong>Design Phase</strong><span>Completed</span></div>\n  </div>\n  <div class="tl-item-uv active">\n    <div class="tl-dot-uv"></div>\n    <div class="tl-content-uv"><strong>Development</strong><span>In progress</span></div>\n  </div>\n  <div class="tl-item-uv">\n    <div class="tl-dot-uv"></div>\n    <div class="tl-content-uv"><strong>Testing</strong><span>Pending</span></div>\n  </div>\n</div>`,
    css: `.timeline-card-uv { background: #1e1e1e; border-radius: 16px; padding: 24px; color: #fff; font-family: system-ui, sans-serif; width: 260px; }\n.tl-item-uv { display: flex; align-items: center; gap: 14px; padding: 12px 0; position: relative; }\n.tl-item-uv:not(:last-child)::after { content: ""; position: absolute; left: 7px; top: 36px; width: 2px; height: calc(100% - 20px); background: #333; }\n.tl-dot-uv { width: 16px; height: 16px; border-radius: 50%; background: #333; flex-shrink: 0; border: 2px solid #333; }\n.tl-item-uv.active .tl-dot-uv { background: #667eea; border-color: #667eea; box-shadow: 0 0 8px #667eea60; }\n.tl-content-uv strong { display: block; font-size: 0.85rem; }\n.tl-content-uv span { font-size: 0.7rem; color: #888; }`,
  },
  {
    id: "card-crypto",
    name: "Crypto Price",
    author: "gharsh11032000",
    html: `<div class="crypto-card-uv">\n  <div class="crypto-head-uv">\n    <span class="crypto-coin-uv">₿</span>\n    <div><strong>Bitcoin</strong><span>BTC</span></div>\n    <span class="crypto-change-uv">+5.2%</span>\n  </div>\n  <div class="crypto-price-uv">$43,250.80</div>\n  <div class="crypto-chart-uv">\n    <svg viewBox="0 0 200 40"><polyline points="0,30 30,25 60,35 90,15 120,20 150,10 180,18 200,5" fill="none" stroke="#4ade80" stroke-width="2"/></svg>\n  </div>\n</div>`,
    css: `.crypto-card-uv { background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 16px; padding: 20px; color: #fff; font-family: system-ui, sans-serif; width: 260px; }\n.crypto-head-uv { display: flex; align-items: center; gap: 10px; margin-bottom: 12px; }\n.crypto-coin-uv { font-size: 1.5rem; width: 36px; height: 36px; background: #f7931a20; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #f7931a; }\n.crypto-head-uv strong { display: block; font-size: 0.85rem; }\n.crypto-head-uv span { font-size: 0.7rem; color: #888; }\n.crypto-change-uv { margin-left: auto; color: #4ade80; font-size: 0.8rem; font-weight: 600; }\n.crypto-price-uv { font-size: 1.5rem; font-weight: 700; margin-bottom: 12px; }\n.crypto-chart-uv svg { width: 100%; height: 40px; }`,
  },
  {
    id: "card-alert",
    name: "Alert Card",
    author: "cssbuttons-io",
    html: `<div class="alert-card-uv">\n  <div class="alert-strip-uv"></div>\n  <div class="alert-body-uv">\n    <span class="alert-type-uv">⚠️ Warning</span>\n    <p>Your subscription expires in 3 days. Renew now to avoid service interruption.</p>\n    <button class="alert-action-uv">Renew Now</button>\n  </div>\n</div>`,
    css: `.alert-card-uv { background: #1e1e1e; border-radius: 12px; overflow: hidden; display: flex; width: 320px; font-family: system-ui, sans-serif; color: #fff; }\n.alert-strip-uv { width: 5px; background: #f59e0b; flex-shrink: 0; }\n.alert-body-uv { padding: 16px 20px; }\n.alert-type-uv { font-size: 0.85rem; font-weight: 600; display: block; margin-bottom: 6px; }\n.alert-body-uv p { font-size: 0.8rem; color: #aaa; line-height: 1.4; margin-bottom: 12px; }\n.alert-action-uv { padding: 6px 16px; background: #f59e0b; border: none; border-radius: 6px; color: #000; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: background 0.2s; }\n.alert-action-uv:hover { background: #d97706; }`,
  },
  {
    id: "card-newsletter",
    name: "Newsletter Card",
    author: "mrhyddenn",
    html: `<div class="news-card-uv">\n  <h3>Stay Updated</h3>\n  <p>Get the latest news and updates delivered to your inbox.</p>\n  <div class="news-input-row-uv">\n    <input class="news-email-uv" placeholder="Enter your email">\n    <button class="news-btn-uv">→</button>\n  </div>\n</div>`,
    css: `.news-card-uv { background: linear-gradient(135deg, #1a1a2e, #16213e); border-radius: 16px; padding: 28px; color: #fff; font-family: system-ui, sans-serif; width: 300px; }\n.news-card-uv h3 { font-size: 1.1rem; margin-bottom: 6px; }\n.news-card-uv p { font-size: 0.8rem; color: #888; margin-bottom: 20px; }\n.news-input-row-uv { display: flex; gap: 8px; }\n.news-email-uv { flex: 1; padding: 10px 14px; background: #0d1117; border: 1px solid #333; border-radius: 8px; color: #fff; font-size: 0.85rem; outline: none; }\n.news-email-uv:focus { border-color: #667eea; }\n.news-btn-uv { padding: 10px 16px; background: #667eea; border: none; border-radius: 8px; color: #fff; font-size: 1rem; cursor: pointer; transition: background 0.2s; }\n.news-btn-uv:hover { background: #5a6fd6; }`,
  },
  {
    id: "card-order",
    name: "Order Summary",
    author: "Smit-Prajapati",
    html: `<div class="order-card-uv">\n  <h3>Order Summary</h3>\n  <div class="order-item-uv"><span>Premium Plan</span><span>$29.00</span></div>\n  <div class="order-item-uv"><span>Tax</span><span>$2.90</span></div>\n  <div class="order-total-uv"><span>Total</span><span>$31.90</span></div>\n  <button class="order-pay-uv">Pay Now</button>\n</div>`,
    css: `.order-card-uv { background: #1e1e1e; border: 1px solid #2a2a2a; border-radius: 16px; padding: 24px; color: #fff; font-family: system-ui, sans-serif; width: 260px; }\n.order-card-uv h3 { font-size: 1rem; margin-bottom: 16px; }\n.order-item-uv { display: flex; justify-content: space-between; padding: 8px 0; font-size: 0.85rem; color: #aaa; border-bottom: 1px solid #222; }\n.order-total-uv { display: flex; justify-content: space-between; padding: 12px 0; font-size: 1rem; font-weight: 700; margin-bottom: 16px; }\n.order-pay-uv { width: 100%; padding: 12px; border: none; border-radius: 10px; background: linear-gradient(135deg, #10b981, #059669); color: #fff; font-size: 0.9rem; font-weight: 600; cursor: pointer; transition: transform 0.2s; }\n.order-pay-uv:hover { transform: translateY(-2px); }`,
  },
];
